...
export function HomePage() {
    ...
    async function getUserOwnedDocuments() {
        ...
        const response = await fetch(`http://98.66.168.16/document/${userId}/owneddocs`
            , {
                header: {
    ...
    async function getUserEditedDocuments() {
        const userId = localStorage.getItem('userId')
        const response = await fetch(`http://98.66.168.16/document/${userId}/editeddocs`
            , {
                header: {
                    "Content-Type": "application/json",
                    "accept": "application/json"
    ...
    async function getUserViewedDocuments() {
        const userId = localStorage.getItem('userId')
        const response = await fetch(`http://98.66.168.16/document/${userId}/vieweddocs`
            , {
                header: {
                    "Content-Type": "application/json",
                    "accept": "application/json"
    ...
    async function getUserEditorDocuments() {
        const response = await fetch(`http://98.66.168.16/document/editor/${username}`
            , {
                header: {
                    "Content-Type": "application/json",
                    "accept": "application/json"
    ...
    async function getUserViewerDocuments() {
        const response = await fetch(`http://98.66.168.16/document/viewer/${username}`
            , {
                header: {
                    "Content-Type": "application/json",
                    "accept": "application/json"
